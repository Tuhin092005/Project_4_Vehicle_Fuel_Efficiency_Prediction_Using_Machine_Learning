...
# Display predicted fuel efficiency
...
for column in categorical_columns:
    new_data1[column] = label_encoders[column].transform(new_data1[column])
...
prediction1 = best_model.predict(new_data1)

# Display predicted fuel efficiency

print("Predicted Fuel Efficiency:", prediction1[0], "km/L")
